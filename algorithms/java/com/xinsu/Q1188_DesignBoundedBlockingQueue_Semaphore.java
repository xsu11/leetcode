 ...
 *
 * 由于生产者/消费者线程的数目可能大于 1 ，我们并不知道线程如何被操作系统调度，即使输入看上去隐含了顺序。因此任意一种输出[1,0,2]或[1,2,0]
 * 或[0,1,2]或[0,2,1]或[2,0,1]或[2,1,0]都可被接受。
 *
 *
 * 提示:
 *
 ...
 */
public class Q1188_DesignBoundedBlockingQueue_Semaphore {
    ...
    public Q1188_DesignBoundedBlockingQueue_Semaphore(int capacity) {
        this.capacity = capacity;
        this.producer = new Semaphore(capacity);
