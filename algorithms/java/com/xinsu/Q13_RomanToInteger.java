...
public class Q13_RomanToInteger {
    ...
    private static final Map<Character, Integer> romanCharMap = new HashMap<>();
    static {
    ...
    public int romanToInt(String s) {
        ...
        for (int i = 0; i < s.length(); i++) {
            int value = romanCharMap.get(s.charAt(i));
            if (i < s.length() - 1 && value < romanCharMap.get(s.charAt(i + 1))) {
                // char before last
                value *= -1;
            }
