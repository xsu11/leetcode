...
public class Q167_TwoSumII_InputArrayIsSorted {
     ...
     * @return an integer array [index1, index2] of length 2, where indices are 1-indexed based
     */
    public int[] twoSum(int[] numbers, int target) {
        // boundary case
        if (numbers.length < 2) {
            throw new IllegalArgumentException("Wrong numbers array!");
        }
        ...
        while (left < right) {
            ...
            if (actual < target) {
                ...
                // found the exact two indices, return
                // WARNING: returned indices need to be 1-indexed
